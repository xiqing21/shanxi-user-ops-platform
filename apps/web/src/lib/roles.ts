...
export const roles: RoleView[] = [
  {
    ...
    scopeLabel: "山西省全量用户",
    defaultTab: "全省态势",
    visibleTabs: ["全省态势", "大工业分析", "AI 问数", "AI 建任务", "多Agent编排", "模拟压测", "运行拓扑"],
    cities: shanxiCities,
    riskFilter: "all",
  ...
  },
  {
    ...
    scopeLabel: "太原市运维视角",
    defaultTab: "全省态势",
    visibleTabs: ["全省态势", "AI 问数", "多Agent编排", "模拟压测", "运行拓扑"],
    cities: ["太原", "晋中", "忻州", "吕梁"],
    riskFilter: "city",
  ...
  },
  {
    ...
    defaultTab: "大工业分析",
    visibleTabs: ["大工业分析", "全省态势", "AI 问数", "AI 建任务", "多Agent编排", "运行拓扑"],
    cities: shanxiCities,
  ...
  },
  {
    ...
    defaultTab: "AI 建任务",
    visibleTabs: ["AI 建任务", "多Agent编排", "AI 问数", "模拟压测", "全省态势", "运行拓扑"],
    cities: shanxiCities,
    riskFilter: "ai",
